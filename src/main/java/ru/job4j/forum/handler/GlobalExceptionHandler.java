package ru.job4j.forum.handler;
...
import ru.job4j.forum.model.ErrorInformation;
...
/**
 * Class for handling all exception in application
 */
@ControllerAdvice
@Slf4j
...
public class GlobalExceptionHandler {
    ...
    public void handleValidationException(Exception e, HttpServletResponse response, Model model) throws IOException {
    ...
    private void setResponse(Exception e, HttpServletResponse response, String shortMessage) throws IOException {
        ...
        response.getWriter().write(mapper.writeValueAsString(
                new ErrorInformation(shortMessage, messagesMap.get("LongMessage"), messagesMap.get("Anchor")).getError()
        ));
    }
